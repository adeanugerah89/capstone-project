...
import com.anugerah.movieclub.favorite.databinding.FragmentFavoriteBinding
import com.anugerah.movieclub.favorite.di.favoriteModule
...
class FavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as MainActivity).supportActionBar?.title =
            getString(com.anugerah.movieclub.R.string.menu_bottom_favorite)

        movieAdapter.delegate = object : RecyclerViewAdapterDelegate<Movie> {
            override fun onClick(t: Movie) {
                val action =
                    FavoriteFragmentDirections.actionFavoriteFragmentToDetailMovieFragment(t)
